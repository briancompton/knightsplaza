				...
				<div class="col-md-2 tower hidden-xs hidden-sm">
					<div class="row">
						...
						<div class="col-md-12 logo">
							<div class="row">
								<div class="col-md-12">
									<a href="<?php echo home_url(); ?>" title="University of Central Florida">
					...
					<div class="col-md-10 col-sm-12 col-xs-12 castle pull-right">
						...
						<div class="col-md-12 hero hidden-xs">
							<div class="row">
								...
								<?php $attachments = get_children( array( 'post_parent' => $id, 
								 ...
								 if( $attachments ) {
								 	...
								 	echo wp_get_attachment_image( $att_id, array( 1024,240 ) );	
								 	} else { ?>
									 	<img src="<?php echo get_template_directory_uri(); ?>/img/hero-placeholder.jpg" alt="hero-placeholder">
								 	<?php ;}							 	?>
								 <?php endwhile; ?>
							...
							<div class="col-md-6 pull-right nav-utility">
								<header id="masthead" class="site-header" role="banner">
									...
									<nav id="site-navigation" class="main-navigation" role="navigation">
										...
										<?php  wp_nav_menu( array( 'theme_location' => 'nav-upper', 'items_wrap' => '<ul id="%1$s" class="%2$s pull-right">%3$s<li><a class="upper-search"><span class="kp-search search-top"></span></a></li></ul>' ) ); ?>
									</nav><!-- #site-navigation -->
