		 	...
		 	<div class="row enceinte">
				...
				<div class="col-md-2 tower hidden-xs hidden-sm">
					...
					<div class="col-md-10 col-sm-12 col-xs-12 castle pull-right">
						...
						<div class="col-md-12 hero hero-eat hidden-xs">
							<div class="row">

								<div class="hero-burger">
									<img src="<?php echo get_template_directory_uri(); ?>/img/hero-eat-too.gif" alt="hero-eat">	
								</div>
								
								<!--
<div class="hero-guy">
									<img src="<?php echo get_template_directory_uri(); ?>/img/hero-eat-guy.png" alt="hero-eat-guy" width="544">
								</div>	
-->
